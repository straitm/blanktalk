...
\begin{center}
\includegraphics[width=0.5\columnwidth]{fig-bhbh-nu.png}
\end{center}
...
\item LIGO reach is about half that for black hole/black
...
\item Would be nice to have a SNEWS-like trigger that actually triggers
sometimes
